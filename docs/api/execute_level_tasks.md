...
SDK 保持 5 分钟等待；框架请求总预算 4 分 45 秒。超时、断线、结果未知均不自动重放。完整面板、过滤与计划功能可使用 [execute_level_task_selection](/api/execute_level_task_selection.html)。
