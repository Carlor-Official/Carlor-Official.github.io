...
1. 从[用户系统独立 Release](https://github.com/Carlor-Official/Mengka-User-System/releases/tag/v2.0.17-native-ipc)下载对应的外发包、包清单和 `SHA256SUMS.txt`；框架安装包仍从[框架 v2.4.1 Release](https://github.com/Carlor-Official/Mengka-NT/releases/tag/v2.4.1)获取；
