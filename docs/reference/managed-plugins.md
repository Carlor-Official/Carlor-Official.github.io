...
开发者通过[开发者平台](https://mknt.rezcwl.com/developers/)提交资料，账号由管理员统一管理。填写名称、唯一 ID、版本、简介、Logo、最低框架版本、更新日志及各系统下载地址，选择安装文件，补充接入模式、监听端口和 Web 后台信息。新官网仅提供文档入口，不承载用户登录或插件审核后端。
