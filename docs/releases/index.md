...
框架 v2.4.0 的核心变化包括本地管理员初始化、插件导入与本地托管运行、协议目录更新，以及由算法服务统一管理框架版本策略。用户系统插件的独立包请从其[官方 Release](https://github.com/Carlor-Official/Mengka-User-System/releases)获取，再在框架插件导入页上传。
